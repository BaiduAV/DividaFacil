...
def create_test_expenses_with_categories():
    ...
    try:
        ...
        test_expenses = [
            ...
            {"description": "Uber to airport", "amount": 23.75, "category": "Transportation"},
            {"description": "Movie tickets", "amount": 18.00, "category": "Entertainment"},
            {"description": "Hotel booking", "amount": 120.00, "category": "Accommodation"},
            {"description": "Office supplies", "amount": 15.30, "category": "General"},
            {
        ...
        for expense_data in test_expenses:
            ...
            print(
                f"✓ Created expense: {expense.description} (Category: {expense.category or 'None -> General'})"
            )
    ...
    try:
        ...
        for group in groups:
            ...
            for expense in expenses:
                category_display = (
                    expense.category if expense.category else "None (defaults to General)"
                )
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--create", action="store_true", help="Create test expenses with categories"
    )
