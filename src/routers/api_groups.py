...
async def create_group_api(group_data: GroupCreate, current_user: User = Depends(require_authentication)):
...
async def add_member_api(group_id: str, user_id: str, current_user: User = Depends(require_authentication)):
