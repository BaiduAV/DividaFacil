...
class BalanceService:
    ...
    def calculate_group_balances(self, expenses: List[Expense], users: Dict[str, User]) -> List[Balance]:
        """
    ...
    def generate_settlement_suggestions(self, balances: List[Balance]) -> List[SettlementSuggestion]:
        """
    ...
    def calculate_group_statistics(self, expenses: List[Expense], users: Dict[str, User]) -> Dict[str, any]:
        """
